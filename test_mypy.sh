...
yes | scp -i root_key ./mypy_test_cache.zip root@$serverIp:~/cache/celery---celery.zip
yes | scp -i root_key ./mypy_test_report.txt root@$serverIp:~/report/celery---celery.txt
